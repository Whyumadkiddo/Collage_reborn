        ...
        try {
            ...
            for (String category : categories) {
                ...
                for (TableData item : data) {
                    String group = item.getSemester2();
                    if (group != null) {
                        if (!groupSummaryMap.containsKey(group)) {
                            groupSummaryMap.put(group, new GroupHoursSummary(group, "0", "0", "0"));
                        }
